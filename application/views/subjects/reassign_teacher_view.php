       		...
       		<div class="block-content collapse in">
                ...
                <fieldset>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <?php echo form_dropdown('selTerm', $markingperiod,set_value('selTerm', $course->marking_period_id.'|'.$course->term_short_name),'id="selTerm"');?>
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label" for="title">Teacher</label>
                    <div class="controls">
                    	 <?php echo form_dropdown('selTeacher', $teachers, set_value('selTeacher', $course->teacher_id),'id="selTeacher"'); ?>
                    </div>
                  </div>
