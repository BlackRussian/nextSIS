		...
		<div class="navbar">
  		...
  		<div class="container-fluid">
  			<div class="row-fluid">
        		...
        		<div class="span8">
        		<?php echo form_open('schoolclasses/editrecord'); ?>
					<h1>Edit School Classes</h1>
					<table>
					<?php echo "<input type='hidden' id='cid' name='cid' value='" .$id ."'  />"?>
					...
					<tr>
						...
						<td>
							<?php echo "<input type='text' id='title' name='title' value='" .$title ."' />"?>
					</tr>
					<tr>
						<td>Next Grade Level</td>
						<td>
						...
						foreach($gradelevels as $level){ 
							...
							$value= $level->id;
							$text = $level->title;
							if($gid == $value){$selected = 'selected';}
