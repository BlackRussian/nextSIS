...
-->
	...
	<!-- Header -->
	<div class="header">
		<span><a href="<?php echo base_url();?>"><img alt="nextsis logo" height="90" width="90" src="<?php echo base_url('assets/img/pbhs.jpg');?>"></a></span>
		<span class="header">Paul Bogle High School<br><?php echo $this->lang->line('student_information_system');?></span>
	</div>
	...
	<span class="login">
		...
		<?php echo "<input type='hidden' id='defaultschid' name='defaultschid' value='" .$defaultschid ."'  />"?>
