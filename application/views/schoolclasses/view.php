  			...
  			<div class="row-fluid">
  				<div class="span4 navleft">
  					<ul class="nav nav-pills nav-stacked">
  						...
  						<li class="active"><a href="../schoolclasses/listing"><?php echo $this->lang->line("schoolclasses");?></a></li>
        		...
        		<div class="span8">
					<h1><?php echo $this->lang->line("schoolclasses");?></h1>
					<table>
					<tr>
						<td>
						Class
				 	...
				 	function is_iterable($var)
					{
				 	 ...
				 	 if(is_iterable($query)){  foreach($query as $class){?>
						<tr>
							<td>
							...
							<td>
								<?php 
								if(isset($class->schoolgradelevels_id)){
									foreach($gradelevels as $gl)
									{
										
										if($gl->id == $class->schoolgradelevels_id)		
										{
											echo $gl->title;												
										}								
									}
							...
							<td>
								...
								<a href="edit/<?php echo urlencode($class->id); ?>"><?php echo $this->lang->line("edit_schoolclass");?></a>
							</td>
							<td>
